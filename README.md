...
- Peak power hold
- SWR monitoring
- Dual DS18B20 temperature monitoring (amplifier and transverter) or whatever you choose
- Dual INA219 voltage and current monitoring of transverter and amp
...
- Fully calibratable via browser interface and the SatStat Windows program
...
- ESP32-C5
- Waterproof box
- Mic connectors (male and female)
- Multi core cable
